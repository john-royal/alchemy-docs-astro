...
<Aside type="tip">
  Learn how to implement your own state storage in [Custom State Stores
  Guide](../guides/custom-state-store)
</Aside>
...
<Aside type="note">
  Always use `alchemy.secret()` for sensitive values to prevent them from being
  stored in plain text.
</Aside>

<Aside type="note">
  Learn more about secrets management in [Concepts: Secrets](./secret)
</Aside>
