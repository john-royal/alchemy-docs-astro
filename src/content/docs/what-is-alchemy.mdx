...
<Aside type="note">
  You usually don't want to edit these files, but when things go wrong, having
  state that is easy to understand and change is useful.
</Aside>
...
[Learn more about custom state stores](./guides/custom-state-store)
...
[Learn more about AI-generated resources](./guides/custom-resources)
