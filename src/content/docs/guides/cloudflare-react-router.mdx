...
<CommandGroup
  bun={["bun create cloudflare@latest my-react-router-app --framework=react-router"]}
  npm={["npm create cloudflare@latest -- my-react-router-app --framework=react-router"]}
  pnpm={["pnpm create cloudflare@latest my-react-router-app --framework=react-router"]}
...
<CommandGroup
  ...
  npm={["npm install alchemy cloudflare", "bun install --save-dev @cloudflare/workers-types"]}
  pnpm={["pnpm add alchemy cloudflare", "pnpm add -D @cloudflare/workers-types"]}
  yarn={["yarn add alchemy cloudflare", "yarn add -D @cloudflare/workers-types"]}
/>
