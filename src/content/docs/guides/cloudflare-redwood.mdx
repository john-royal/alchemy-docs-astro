...
<CommandGroup
  bun={["bunx degit redwoodjs/example-drizzle my-cloudflare-app", "cd my-cloudflare-app", "bun install"]}
  npm={["npx degit redwoodjs/example-drizzle my-cloudflare-app", "cd my-cloudflare-app", "npm install"]}
  pnpm={["pnpm dlx degit redwoodjs/example-drizzle my-cloudflare-app", "cd my-cloudflare-app", "pnpm install"]}
  yarn={["yarn dlx degit redwoodjs/example-drizzle my-cloudflare-app", "cd my-cloudflare-app", "yarn install"]}
/>
