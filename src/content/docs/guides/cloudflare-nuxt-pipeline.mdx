...
<CommandGroup
  bun={["bun create nuxt-app", "cd my-nuxt-app", "bun install"]}
  npm={["npm create nuxt-app", "cd my-nuxt-app", "npm install"]}
  pnpm={["pnpm create nuxt-app", "cd my-nuxt-app", "pnpm install"]}
  yarn={["yarn create nuxt-app", "cd my-nuxt-app", "yarn install"]}
/>
