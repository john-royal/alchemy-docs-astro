...
import CommandGroup from "../../../components/command-group.astro";
...
<CommandGroup
  bun={["bun create svelte@latest my-sveltekit-app", "cd my-sveltekit-app", "bun install"]}
  npm={["npm create svelte@latest my-sveltekit-app", "cd my-sveltekit-app", "npm install"]}
  pnpm={["pnpm create svelte@latest my-sveltekit-app", "cd my-sveltekit-app", "pnpm install"]}
  yarn={["yarn create svelte@latest my-sveltekit-app", "cd my-sveltekit-app", "yarn install"]}
/>
...
<CommandGroup
  bun={["bun add @sveltejs/adapter-cloudflare alchemy cloudflare", "bun add -D @cloudflare/workers-types"]}
  npm={["npm install @sveltejs/adapter-cloudflare alchemy cloudflare", "npm install --save-dev @cloudflare/workers-types"]}
  pnpm={["pnpm add @sveltejs/adapter-cloudflare alchemy cloudflare", "pnpm add -D @cloudflare/workers-types"]}
  yarn={["yarn add @sveltejs/adapter-cloudflare alchemy cloudflare", "yarn add -D @cloudflare/workers-types"]}
/>
