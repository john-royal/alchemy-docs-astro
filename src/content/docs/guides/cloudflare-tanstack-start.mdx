...
<CommandGroup
  bun={["bunx gitpick TanStack/router/tree/main/examples/react/start-basic start-basic", "cd start-basic", "bun install"]}
  npm={["npx gitpick TanStack/router/tree/main/examples/react/start-basic start-basic", "cd start-basic", "npm install"]}
  pnpm={["pnpm dlx gitpick TanStack/router/tree/main/examples/react/start-basic start-basic", "cd start-basic", "pnpm install"]}
  yarn={["yarn dlx gitpick TanStack/router/tree/main/examples/react/start-basic start-basic", "cd start-basic", "yarn install"]}
/>
