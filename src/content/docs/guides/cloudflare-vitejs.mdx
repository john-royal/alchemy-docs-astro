...
<CommandGroup
  bun={["bun create cloudflare@latest my-react-app --framework=react --platform=workers --no-deploy"]}
  npm={["npm create cloudflare@latest my-react-app -- --framework=react --platform=workers --no-deploy"]}
  pnpm={["pnpm create cloudflare@latest my-react-app -- --framework=react --platform=workers --no-deploy"]}
  yarn={["yarn create cloudflare@latest my-react-app -- --framework=react --platform=workers --no-deploy"]}
/>
