...
<CommandGroup
  node={["# Install from https://nodejs.org/", "node --version"]}
  bun={["# Install from https://bun.sh/", "bun --version"]}
  deno={["# Install from https://deno.com/", "deno --version"]}
/>
...
<CommandGroup
  ...
  npm={["mkdir my-alchemy-app", "cd my-alchemy-app", "npm init -y", "npm install -D typescript @types/node tsx"]}
  pnpm={["mkdir my-alchemy-app", "cd my-alchemy-app", "pnpm init", "pnpm add -D typescript @types/node tsx"]}
  yarn={["mkdir my-alchemy-app", "cd my-alchemy-app", "yarn init -y", "yarn add -D typescript @types/node tsx"]}
/>
